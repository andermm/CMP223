...
*Analysis (2019/2)* final work.

Here is the entire project used to perform the proposed final work
activity. Below are the files and folders, along with the analysis
