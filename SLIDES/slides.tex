...
\vfill
Assess the impact of network interconnect on HPC applications regarding performance and  execution cost
\pause \vfill
How do the communication characteristics of applications influence their performance?
\pause \vfill
Is it possible to optimize both performance and execution cost just by using another interconnect?
\pause \vfill
...
\pause \vfill
    \item All applications were also tracked, exposing their communication and computing characteristics both rank by rank and as a percentage
\pause \vfill
...
\begin{frame}{Trace}
To track the applications were used:
\pause \vfill
    \begin{itemize}
...
Observations
\begin{itemize}
    \item Alya performance is increased by up to $\approx$16\%
