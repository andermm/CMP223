...
{\color[HTML]{000000} Alya} & {\color[HTML]{000000} US\$ 0.064} & {\color[HTML]{000000} US\$ 0.068} & {\color[HTML]{000000} US\$ -0.004} & {\color[HTML]{000000} -6.4\%} \\
{\color[HTML]{000000} EP} & {\color[HTML]{000000} US\$ 0.008} & {\color[HTML]{000000} US\$ 0.010} & {\color[HTML]{000000} US\$ -0.002} & {\color[HTML]{000000} -19.8\%} \\
{\color[HTML]{000000} FT} & {\color[HTML]{000000} US\$ 0.342} & {\color[HTML]{000000} US\$ 0.039} & {\color[HTML]{000000} US\$ 0.303} & {\color[HTML]{000000} 770\%} \\
{\color[HTML]{000000} IMB-CPU} & {\color[HTML]{000000} US\$ 0.001} & {\color[HTML]{000000} US\$ 0.002} & {\color[HTML]{000000} US\$ -0.001} & {\color[HTML]{000000} -19.2\%} \\ \hline
\end{tabular}%
}
\end{table}
\end{frame}
