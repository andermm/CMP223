...
\begin{center}
    \includegraphics[scale=0.5]{SLIDES/img/System1.pdf}
\end{center}
    \begin{itemize}
    \item (1) teste te
    \vfill
    ...
    \framebreak
\begin{center}
    \includegraphics[scale=0.5]{SLIDES/img/System2.pdf}
\end{center}
    \begin{itemize}
    \item (1) teste te
    \item (2) teste
    ...
    \framebreak
\begin{center}
    \includegraphics[scale=0.5]{SLIDES/img/System3.pdf}
\end{center}    
    \begin{itemize}
    \item (1) teste te
    \item (2) teste
    ...
    \framebreak
\begin{center}    
    \includegraphics[scale=0.5]{SLIDES/img/System4.pdf}
\end{center}    
    \begin{itemize}
    \item (1) teste te
    \item (2) teste
