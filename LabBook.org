...
ggplot(df_intel_latency,aes(x=bytes, y=average)) +
  ...
  scale_colour_manual(values=c( "#BEBEBE", "#303030", "#888888"), name="Network Interface",
...
geom_errorbar(aes(ymin=average-ste, ymax=average+ste), width=.1, position = position_dodge(.3)) +
theme_bw() +
