...
<
<int>
 1 exec_alya eth         297.  1.82  1.07     26
 2 exec_alya ib          255.  2.83  1.70     25
 3 exec_alya ipoib       281.  3.11  1.87     25
 4 exec_bt   eth         505.  1.33  0.799    25
 5 exec_bt   ib          380.  4.17  2.45     26
 6 exec_bt   ipoib       544.  3.46  2.04     26
 7 exec_cg   eth         759.  8.01  4.80     25
 8 exec_cg   ib          183.  0.947 0.568    25
 9 exec_cg   ipoib       181.  1.80  1.06     26
10 exec_ep   eth          37.4 0.451 0.271    25
# … with 23 more rows
...
<
<int>
 1 eth           1    6.45 0.452 0.271    25
 2 eth           2    6.3  0.459 0.275    25
 3 eth           4    6.21 0.464 0.279    25
 4 eth           8    6.09 0.352 0.211    25
 5 eth          16    6.03 0.315 0.189    25
 6 eth          32    6.00 0.286 0.171    25
 7 eth          64    5.99 0.264 0.158    25
 8 eth         128    6.01 0.271 0.163    25
 9 eth         256    6.01 0.247 0.148    25
10 eth         512    6.03 0.208 0.125    25
# … with 59 more rows
...
# Groups:   interface [3]
 ...
 <
  <
<int>
 1 eth           1   0.156 0.0104 0.00622    25
 2 eth           2   0.319 0.0227 0.0136     25
 3 eth           4   0.647 0.0466 0.0280     25
 4 eth           8   1.32  0.0750 0.0450     25
 5 eth          16   2.66  0.135  0.0811     25
 6 eth          32   5.35  0.247  0.148      25
 7 eth          64  10.7   0.455  0.273      25
 8 eth         128  21.3   0.930  0.558      25
 9 eth         256  42.7   1.69   1.01       25
10 eth         512  85.1   2.82   1.69       25
# … with 59 more rows
#+end_example
*** PingPong - Latency
