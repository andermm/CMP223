...
<
 <
<int>
 1 exec_alya eth         297.  1.55  0.547      8
 2 exec_alya ib          254.  1.06  0.373      8
 3 exec_alya ipoib       281.  1.07  0.356      9
 4 exec_bt   eth         504.  1.58  0.528      9
 5 exec_bt   ib          381.  2.41  0.804      9
 6 exec_bt   ipoib       545.  2.89  1.02       8
 7 exec_cg   eth         753.  2.90  0.966      9
 8 exec_cg   ib          183.  1.04  0.347      9
 9 exec_cg   ipoib       181.  1.69  0.565      9
10 exec_ep   eth          37.3 0.143 0.0476     9
# … with 23 more rows
...
# Groups:   interface [3]
 ...
 <
<int>
 1 eth           1    6.47 0.497  0.166      9
 2 eth           2    6.31 0.439  0.146      9
 3 eth           4    6.24 0.412  0.137      9
 4 eth           8    6.13 0.326  0.109      9
 5 eth          16    6.07 0.257  0.0855     9
 6 eth          32    6.01 0.187  0.0622     9
 7 eth          64    5.99 0.147  0.0490     9
 8 eth         128    5.98 0.131  0.0436     9
 9 eth         256    5.96 0.106  0.0352     9
10 eth         512    5.99 0.0875 0.0292     9
# … with 59 more rows
...
# Groups:   interface [3]
 ...
 <
  <
<int>
 1 eth           1   0.156 0.0101 0.00338     9
 2 eth           2   0.318 0.0222 0.00741     9
 3 eth           4   0.646 0.0403 0.0134      9
 4 eth           8   1.31  0.0665 0.0222      9
 5 eth          16   2.64  0.107  0.0358      9
 6 eth          32   5.33  0.161  0.0537      9
 7 eth          64  10.7   0.256  0.0853      9
 8 eth         128  21.4   0.468  0.156       9
 9 eth         256  42.9   0.768  0.256       9
10 eth         512  85.4   1.23   0.409       9
# … with 59 more rows
#+end_example
...
geom_bar(stat="identity", position = "dodge", width = 0.2, colour="black") +
geom_errorbar(aes(ymin=average-ste, ymax=average+ste), width=.05, position = position_dodge(.2)) +
theme_minimal() +
scale_fill_manual(values=c("#000000", "#888888", "#FFFFFF"), name="Network Interface",
...
ggplot(df_apps[df_apps$apps %in% c("exec_ft"), ] , aes(x=apps, y=average, fill=interface)) +
geom_bar(stat="identity", position = "dodge", width = 0.11, colour="black") +
geom_errorbar(aes(ymin=average-ste, ymax=average+ste), width=.05, position = position_dodge(.11)) +
theme_minimal() +
scale_fill_manual(values=c("#000000", "#888888", "#FFFFFF"), name="Network Interface",
breaks=c("ib", "ipoib", "eth"), labels=c("InfiniBand", "IP-over-IB", "Ethernet")) +
theme(legend.position = c(0.15, 0.85), 
...
geom_bar(stat="identity", position = "dodge", width = 0.3, colour="black") +
...
ggplot(df_apps[df_apps$apps %in% c("exec_cg", "exec_lu"), ] , aes(x=apps, y=average, fill=interface)) +
geom_bar(stat="identity", position = "dodge", width = 0.2, colour="black") +
geom_errorbar(aes(ymin=average-ste, ymax=average+ste), width=.05, position = position_dodge(.2)) +
theme_minimal() +
scale_fill_manual(values=c("#000000", "#888888", "#FFFFFF"), name="Network Interface",
...
*** Alya(160 Procs)
#+begin_src R :results output graphics :file R/PLOTS/Alya.png :exports both :width 600 :height 400 :session *R*  
labs <- c("ALYA")
df_apps$interface <- factor(df_apps$interface,
levels=c("ib", "ipoib", "eth"))

ggplot(df_apps[df_apps$apps %in% c("exec_alya"), ] , aes(x=apps, y=average, fill=interface)) +
geom_bar(stat="identity", position = "dodge", width = 0.15, colour="black") +
geom_errorbar(aes(ymin=average-ste, ymax=average+ste), width=.05, position = position_dodge(.15)) +
theme_minimal() +
scale_fill_manual(values=c("#000000", "#888888", "#FFFFFF"), name="Network Interface",
breaks=c("ib", "ipoib", "eth"), labels=c("InfiniBand", "IP-over-IB", "Ethernet")) +
theme(legend.position = c(0.15, 0.85), 
...
#+RESULTS:
[[file:R/PLOTS/Alya.png]]
*** IMB-Memory
#+begin_src R :results output graphics :file R/PLOTS/IMB.png :exports both :width 600 :height 400 :session *R*  
labs <- c("IMB_Memory", "IMB_CPU")
df_apps$interface <- factor(df_apps$interface,
levels=c("ib", "ipoib", "eth"))

ggplot(df_apps[df_apps$apps %in% c("exec_imb_memory", "exec_imb_CPU"), ] , aes(x=apps, y=average, fill=interface)) +
geom_bar(stat="identity", position = "dodge", width = 0.18, colour="black") +
geom_errorbar(aes(ymin=average-ste, ymax=average+ste), width=.05, position = position_dodge(.18)) +
theme_minimal() +
scale_fill_manual(values=c("#000000", "#888888", "#FFFFFF"), name="Network Interface",
breaks=c("ib", "ipoib", "eth"), labels=c("InfiniBand", "IP-over-IB", "Ethernet")) +
theme(legend.position = c(0.15, 0.85), 
