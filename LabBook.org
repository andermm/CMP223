...
[[SH/software_install.sh]]. On the other hand, if you do not have
...
** System Information 
   ...
   was used the bash script [[SH/sys_info_collect.sh]], which creates
...
- [[SH/benchmarks_charac.sh][benchmark]] 
-
